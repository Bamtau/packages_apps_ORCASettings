...
public class CreateShortcut extends LauncherActivity {
    ...
    private int getProperShortcutIcon(String className) {
        ...
        if (c.equals("GeneralUI"))
            return R.drawable.ic_orca_settings_general_ui;
        else if (c.equals("NavigationBar"))
            return R.drawable.ic_orca_settings_navigation_bar;
        else if (c.equals("QuickToggles"))
            return R.drawable.ic_orca_settings_quick_toggles;
        else if (c.equals("StatusBarClock"))
            return R.drawable.ic_orca_settings_clock;
        else if (c.equals("StatusBarSignal"))
            return R.drawable.ic_orca_settings_signal;
        else if (c.equals("PowerMenu"))
            return R.drawable.ic_orca_settings_power_menu;
        else if (c.equals("StatusBar"))
            return R.drawable.ic_orca_settings_statusbar;
        else
